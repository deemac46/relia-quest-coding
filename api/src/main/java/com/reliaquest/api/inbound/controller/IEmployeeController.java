...
public interface IEmployeeController<Entity, Input> {
    ...
    @GetMapping()
    ResponseEntity<List<Entity>> getAllEmployees() throws ApiException;

    @GetMapping("/search/{searchString}")
    ResponseEntity<List<Entity>> getEmployeesByNameSearch(@PathVariable String searchString) throws ApiException;

    @GetMapping("/{id}")
    ResponseEntity<Entity> getEmployeeById(@PathVariable String id) throws ApiException;

    @GetMapping("/highestSalary")
    ResponseEntity<Integer> getHighestSalaryOfEmployees() throws ApiException;

    @GetMapping("/topTenHighestEarningEmployeeNames")
    ResponseEntity<List<String>> getTopTenHighestEarningEmployeeNames() throws ApiException;

    @PostMapping()
    ResponseEntity<Entity> createEmployee(@RequestBody Input employeeInput) throws IOException, InterruptedException, ApiException;

    @DeleteMapping("/{id}")
    ResponseEntity<String> deleteEmployeeById(@PathVariable String id) throws IOException, InterruptedException, ApiException;
}
